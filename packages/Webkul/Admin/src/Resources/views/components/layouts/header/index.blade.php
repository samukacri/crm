        ...
        <a href="{{ route('admin.dashboard.index') }}">
            ...
            @else
                <img
                    ...
                    src="{{ request()->cookie('dark_mode') ? asset('admin/build/assets/dark-logo-Dnw3cpYj.svg') : asset('admin/build/assets/logo-Bjh7YAuF.svg') }}"
                    id="logo-image"
                    alt="{{ config('app.name') }}"
                />
                ...
                <img
                    ...
                    src="{{ request()->cookie('dark_mode') ? asset('admin/build/assets/mobile-dark-logo-COPgCide.svg') : asset('admin/build/assets/mobile-light-logo-CjoobCkl.svg') }}"
                    id="logo-image"
                    alt="{{ config('app.name') }}"
                />
            @endif
        ...
        app.component('v-dark', {
            ...
            data() {
                return {
                    ...
                    logo: "{{ asset('admin/build/assets/logo-Bjh7YAuF.svg') }}",

                    dark_logo: "{{ asset('admin/build/assets/dark-logo-Dnw3cpYj.svg') }}",
                };
            },
