            ...
            <div class="flex w-full flex-col gap-6">
                <img
                    src="{{ 
                        ...
                        ? asset('admin/build/assets/dark-logo-Dnw3cpYj.svg')
        : asset('admin/build/assets/logo-Bjh7YAuF.svg') 
                    }}"
            ...
            <div class="w-full">
                <img src="{{ vite()->asset('packages/Webkul/Admin/src/Resources/assets/images/error.svg') }}" />
            </div>
        </div>
	</div>
</x-admin::layouts.anonymous>
